...
bio.display_top_contact = function() {
    for (var index in bio.contacts) {
        console.log(bio.contacts[index]);
...
projects.display = function() {
    for (var project in projects.projects) {
        ...
        var formattedProjectURL = HTMLprojectImage.replace("%data%", projects.projects[project].images);
...
education.display_school = function() {
    for (school in education.schools) {
        ...
        for (school in education.onlineCourse) {
            $("#education").append(HTMLschoolStart);
            var formattedNam6e = HTMLonlineTitle.replace("%data%", education.onlineCourse[school].title);
